...
\*********************************/
	...
	$usuario = mysql_fetch_assoc(mysql_query('SELECT user_id, user_name, user_activo, user_baneado FROM u_miembros WHERE LOWER(user_name) = \''.$tsCore->setSecure($username).'\''));
	// EXISTE?
