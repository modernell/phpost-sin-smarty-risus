<?
include TS_THEME.'sections/main_header.php';
?>
		<script type="text/javascript" src="<? echo $tsConfig['js']; ?>/favoritos.js"></script>
		<script type="text/javascript">
                var favoritos_data = [<? echo $tsFavoritos; ?>];
                </script>
                <div class="comunidades">
                    ...
                    <div id="izquierda" style="width:170px;">
                        ...
                        <div class="categoriaList">
                        	<ul>
	                            <li id="cat_-1" style="margin-bottom: 5px;background:#555555; -moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px">
                                        <a href="" onclick="favoritos.active(this); favoritos.categoria = 'todas'; favoritos.query(); return false;" style="color:#FFF">
...
<?
include TS_THEME.'sections/main_footer.php';
?>