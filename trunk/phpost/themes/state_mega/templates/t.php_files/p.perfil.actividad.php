...
<div id="perfil_actividad" status="activo">
    <div class="widget big-info clearfix">
        <div class="title-w clearfix">
			<h3>&Uacute;ltima actividad de <? echo $tsUsername; ?></h3>
			<select onchange="actividad.cargar(<? echo $tsUserID; ?>,'filtrar', this.value)" id="last-activity-filter">
            ...
            <div id="last-activity-date-{$id}" class="date-sep" active="true">
                ...
                <div class="sep">
                    <div class="ac_content">
                        ...
                        <span class="remove"><a onclick="actividad.borrar(<? echo $ac['id']; ?>, this); return false;">x</a></span>
                        {/if}
                    </div>
