                                ...
                                <div id="res" class="boxy-content">
                                	<b>Hola <?  echo $tsUser->nick; ?>!</b>
                                        <br />Si est&aacute;s viendo esto significa que tienes el privilegio de ser moderador en <b>
                                            <? echo $tsConfig['titulo']; ?></b>, por favor lee el protocolo de moderadores para mantener todo en orden.
                                    <hr class="separator" />
                                    ...
                                    <ul id="reglas">
                                        ...
                                        <li>Borrar&aacute; todo post que haya sido denunciado o que detecte que no cumple con las reglas de <b><? echo $tsConfig['titulo']; ?></b>.</li>
                                        ...
                                        <li>De no cumplirse cualquiera de estos puntos el moderador puede sufrir una pena que va desde tres d&iacute;as de suspensi&oacute;n hasta la p&eacute;rdida del cargo y/o expulsi&oacute;n definitiva de <b><? echo $tsConfig['titulo']; ?></b>.</li>
                                    </ul>
                                    <b>Tus colegas moderadores:</b><br />
                                    <?
                                    foreach ($tsMods as $admin)
                                    {
                                    ?>    
                                    	<a href="<?  echo $tsConfig['url']; ?>/perfil/<? echo $admin['user_name']; ?>" class="hovercard" uid="<? echo $admin['user_id']; ?>"><? echo $admin['user_name']; ?></a> |
                                    <?                                    
                                    }
                                    ?>
                                </div>