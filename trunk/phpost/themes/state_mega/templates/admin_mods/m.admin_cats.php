                                	...
                                	<table cellpadding="0" cellspacing="0" border="0" width="500" align="center" class="admin_table" id="cats_orden">
                                        ...
                                        <tbody>
                                        	...
                                        	<tr id="<? echo $c['cid']; ?>">
                                                ...
                                                <td style="text-align:left; padding-left:20px; background:url(<? echo $tsConfig['url']; ?>/themes/default/images/icons/cat/<? echo $c['c_img']; ?>) no-repeat 2px center;"><b><u><? echo $c['c_nombre']; ?></u></b></td>
				...
				{elseif $tsAct == 'editar'}
                                        ...
                                        <fieldset>
                                            ...
                                            <dl>
                                                ...
                                                <dd>
                                                    <img src="<? echo $tsConfig['images']; ?>/space.gif" style="background:url(<? echo $tsConfig['url']; ?>/themes/default/images/icons/cat/{$tsCat.c_img}) no-repeat left center;" width="16" height="16" id="c_icon"/>
                                                    <select name="c_img" id="cat_img" style="width:164px">
                                                    {foreach from=$tsIcons key=i item=img}
                                                    	<option value="{$img}" style="padding:2px 20px 0; background:#FFF url(<? echo $tsConfig['url']; ?>/themes/default/images/icons/cat/{$img}) no-repeat left center;" {if $tsCat.c_img == $img}selected="selected"{/if}>{$img}</option>
                                                    {/foreach}
                                                    </select>
                                                </dd>
                                            </dl>
