					<div class="sidebar-tabs clearbeta">
                        ...
                        <div class="avatar-big-cont">
                            ...
                            <img width="120" height="120" alt="" src="<? echo $tsConfig['url']; ?>/files/avatar/<? if ($tsPerfil['p_avatar']) echo $tsPerfil['user_id'].'_120'; else echo 'avatar' ?>.jpg?t={$smarty.now}" class="avatar-big" id="avatar-img"/>
                        </div>
                    ...
                    <div class="clearfix"></div>
                    <h3 style="margin: 25px 0 0; padding: 0" id="porc-completado-label">Perfil completo al <? echo $tsPerfil['porcentaje']; ?>%</h3>
