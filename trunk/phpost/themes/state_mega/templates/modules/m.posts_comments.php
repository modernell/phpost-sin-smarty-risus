			<div id="post-comentarios">
                        ...
                        ?>        
                            ...
                            <img alt="Bloquear Usuario" src="<?  echo $tsConfig['default']; ?>/images/bloquear_usuario.png" style="float: right">
                            <div style="clear: both;"></div>
                        </div>
                        <? } ?>
                        <div class="comentarios-title">
                            <h4 class="titulorespuestas floatL"><span id="ncomments"><? echo $tsPost['post_comments']; ?></span> Comentarios.</h4>
                            <img src="<? echo $tsConfig['images']; ?>/tload.gif" style="border:0; margin-right:1em; display:none" class="floatR" id="com_gif"/>
                        ...
                        ?>
                        <div class="comentarios-title">
	                        <div class="paginadorCom"><!--HTML de las p�ginas--></div>
                        </div>
                        <? } ?>
                        <div id="comentarios">
                            ...
                            $(document).ready(function(){
                                ...
                                function check_load(){
                                    if (!comentario.cargado && $(window).scrollTop() + $(window).height() > top_cmt ) {
                                        //  
                                        */
                                        comentario.cargar(<? echo $tsPages['post_id']; ?>, 1, <? echo $tsPages['autor'];?>);
                                        /*
                                        // 
			...
			<?
                        ...
                        {
                        ?>        
                            <div id="no-comments">No tienes permisos para comentar.
                            </div>
                        <?                        
                        }                        
			elseif ($tsUser->is_member && ($tsPost['post_block_comments'] != 1 || $tsPost['post_user'] == $tsUser->uid || $tsUser->is_admod || $tsUser->permisos['gopcp']) && $tsPost['block'] == 0)
                        ...
                        <div class="miComentario">
		                    <? include 'm.posts_comments_form.php'; ?>
                        </div>
                        <? } ?>
                    </div>
                    <div class="clearfix"></div>