		<div class="subMenuContent">
            ...
            <div id="subMenuFotos" class="subMenu <? if($tsPage == 'fotos') echo 'here'; ?>">
                <ul class="floatL tabsMenu">
                    ...
                    {
                    ?>    
                    <li class="here"><a href="<? echo $tsConfig['url']; ?>/fotos/<? echo $tsFUser['1']; ?>">&Aacute;lbum de <? echo $tsFUser['1']; ?></a></li>
                    <?                     
                    }
                    if ($tsUser->is_admod || $tsUser->permisos.gopf) 
                    {
                    ?>
                    <li<? if( $tsAction == 'agregar') echo 'class="here"'; ?>><a href="<? echo $tsConfig['url']; ?>/fotos/agregar.php">Agregar Foto</a></li>
                    <?
                    }
                    ?>
