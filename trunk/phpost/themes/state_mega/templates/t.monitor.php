...
include 'sections/main_header.php';
		...
		if ($tsAction == '')
                {   
                    include 'modules/m.monitor_content.php';
                    include 'modules/m.monitor_sidebar.php';
                }    
                else
                {    
...
.btn_follow a {
/* {/literal} */
	background-image: url('<? echo $tsConfig[images]; ?>/btn_follow.png');
/* {literal} */
...
.btn_follow a span {
	...
	height: 19px;
/* {/literal} */
	background-image: url('<? echo $tsConfig[images]; ?>/follow_actions.png');
/* {literal} */
	background-repeat: no-repeat;
}
