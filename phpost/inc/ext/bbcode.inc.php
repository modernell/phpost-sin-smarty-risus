    ...
    */
    private function simpleParse(&$st){
        $bbcodes = array(
            ...
            array("name" => "img","pre" => "<img src=\"","suf" => "\"/>"),
    ...
    */
    private function complexParse(&$st){
        ...
        $elements = array(
            ...
            array("img", "/(?i)\[img\=(http|https|ftp|irc|ed2k|gopher|telnet)?(\:\/\/)?([^\<\>[:space:]]+)\]/i", "<img src=\"\\1\\2\\3\" onload=\"if(this.width > 735) {this.width=735}\" />"),
            array("swf", "/(?i)\[swf\=(.+?)\]/i", "<embed width=\"640\" height=\"390\" wmode=\"transparent\" autoplay=\"false\" allownetworking=\"internal\" allowfullscreen=\"true\" type=\"application/x-shockwave-flash\" quality=\"high\" src=\"\\1\"><br/>"),
