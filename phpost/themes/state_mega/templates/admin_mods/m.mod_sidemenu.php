                                        ...
                                        <li id="a_posts">
                                            <span class="cat-title">
                                                <a onclick="$('#a_posts').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/posts">Post 
                                                    <span class="cadGe cadGe_{if $tsConfig['novemods']['repposts'] > 15}red{elseif $tsConfig['novemods']['repposts'] > 5}purple{else}green{/if}">
                                        ...
                                        <li id="a_fotos">
                                            <span class="cat-title">
                                                <a onclick="$('#a_fotos').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/fotos">Fotos 
                                                    <span class="cadGe cadGe_{if $tsConfig.novemods.repfotos > 15}red{elseif $tsConfig.novemods.repfotos > 5}purple{else}green{/if}">
					...
					<li id="a_mps">
                                            <span class="cat-title">
                                                <a onclick="$('#a_mps').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/mps">Mensajes  
                                                    <span class="cadGe cadGe_{if $tsConfig.novemods.repmps > 15}red{elseif $tsConfig.novemods.repmps > 5}purple{else}green{/if}">
                                                        {$tsConfig.novemods.repmps}</span></a></span></li>
                                        <li id="a_users">
                                            <span class="cat-title">
                                                <a onclick="$('#a_users').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/users">Usuarios 
                                                    <span class="cadGe cadGe_{if $tsConfig.novemods.repusers > 15}red{elseif $tsConfig.novemods.repusers > 5}purple{else}green{/if}">
                                                        {$tsConfig.novemods.repusers}</span></a></span></li>
                                        </ul>
                                        ...
                                        <li id="a_banusers">
                                            <span class="cat-title">
                                                <a onclick="$('#a_banusers').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/banusers">Usuarios suspendidos
                                                    <span class="cadGe cadGe_{if $tsConfig.novemods.supusers > 15}red{elseif $tsConfig.novemods.suspusers > 5}purple{else}green{/if}">
                                                        {$tsConfig.novemods.suspusers}
                                                    </span></a></span></li>{/if}
                                        ...
                                        <li id="a_pospelera">
                                            <span class="cat-title">
                                                <a onclick="$('#a_pospelera').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/pospelera">Post eliminados 
                                                    <span class="cadGe cadGe_{if $tsConfig.novemods.pospelera > 15}red{elseif $tsConfig.novemods.pospelera > 5}purple{else}green{/if}">{$tsConfig.novemods.pospelera}</span></a>                                                    
                                            </span>
                                        </li>{/if}
                                        ...
                                        <li id="a_fopelera">
                                            <span class="cat-title">
                                                <a onclick="$('#a_fopelera').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/fopelera">Fotos eliminadas 
                                                    <span class="cadGe cadGe_{if $tsConfig.novemods.fospelera > 15}red{elseif $tsConfig.novemods.fospelera > 5}purple{else}green{/if}">{$tsConfig.novemods.fospelera}</span></a>
					...
					<h4>Contenido desaprobado</h4>
                                        ...
                                        <li id="a_revposts"><span class="cat-title">
                                                <a onclick="$('#a_revposts').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/revposts">Posts 
                                                    <span class="cadGe cadGe_{if $tsConfig.novemods.revposts > 15}red{elseif $tsConfig.novemods.revposts > 5}purple{else}green{/if}">
                                                        {$tsConfig.novemods.revposts}</span></a>                                                
                                            </span>
                                        </li>{/if}
                                        ...
                                        <li id="a_comentarios"><span class="cat-title">
                                                <a onclick="$('#a_comentarios').addClass('active');" href="<? echo $tsConfig['url']; ?>/moderacion/comentarios">Comentarios 
                                                    <span class="cadGe cadGe_{if $tsConfig.novemods.revcomentarios > 15}red{elseif $tsConfig.novemods.revcomentarios > 5}purple{else}green{/if}">
                                                        $tsConfig.novemods.revcomentarios}</span></a>
