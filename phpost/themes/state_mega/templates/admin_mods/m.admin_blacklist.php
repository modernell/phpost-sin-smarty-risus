                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" class="admin_table">
                                        ...
                                        <tbody>
                                        	...
                                        	<tr id="block_{$b.id}">
                                                ...
                                                <td>{$b.value}</td>
                                                <td>{$b.reason}</td>
                                                <td><a href="<? echo $tsConfig['url']; ?>/perfil/{$b.user_name}" class="hovercard" uid="{$b.user_id}">{$b.user_name}</a></td>
                                                <td>{$b.date|hace}</td>
                                                    <td class="admin_actions">
                                                    <a href="<? echo $tsConfig['url']; ?>/admin/blacklist?act=editar&id={$b.id}">
