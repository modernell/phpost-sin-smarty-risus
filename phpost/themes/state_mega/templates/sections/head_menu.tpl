        ...
        <div id="menu">
			...
			<ul class="menuTabs">
                ...
                <li class="tabbed {if $tsPage == 'posts' || $tsPage == 'home'}here{/if}" id="{if $tsConfig.c_allow_portal && $tsUser->is_member}tabbedposts{else}tabbedhome{/if}">
                    <a title="Ir a Posts" onclick="menu('posts', this.href); return false;" href="{$tsConfig.url}/posts/">Posts <img alt="Drop Down" src="{$tsConfig.tema.t_url}/images/nav.png"></a>
                </li>				
				{if $tsConfig.c_fotos_private == '1' && !$tsUser->is_member}{else}								
                <li class="tabbed {if $tsPage == 'fotos'}here{/if}" id="tabbedfotos">
                    <a title="Ir a Fotos" onclick="menu('fotos', this.href); return false;" href="{$tsConfig.url}/fotos/">Fotos <img alt="Drop Down" src="{$tsConfig.tema.t_url}/images/nav.png"></a>
                </li>								
				{/if}
                <li class="tabbed {if $tsPage == 'tops'}here{/if}" id="tabbedtops">
                    <a title="Ir a TOPs" onclick="menu('tops', this.href); return false;" href="{$tsConfig.url}/top/">TOPs <img alt="Drop Down" src="{$tsConfig.tema.t_url}/images/nav.png"></a>
                </li>
                {if $tsUser->is_member}
                    {if $tsUser->is_admod == 1}
                <li class="tabbed {if $tsPage == 'admin'}here{/if}" id="tabbedAdmin">
                    <a class=qtip title="Panel de Administrador" onclick="menu('Admin', this.href); return false;" href="{$tsConfig.url}/admin/">Administraci&oacute;n <img alt="Drop Down" src="{$tsConfig.tema.t_url}/images/nav.png"></a>
                </li>
   	                {/if}
                {else}
...
<a href="{$tsConfig.url}/perfil/{$tsUser->info.user_name}" class="username" style="color:#D5D5D5;">
<img style="height: 16px; width: 16px;float: left; margin-right: 5px; display: block;" src="{$tsConfig.url}/files/avatar/{$tsUser->uid}_120.jpg"> {$tsUser->nick}</a>
<div class="my-account-links real-shadow navpanel" onmouseout="user_menu_show(0);" style="display: none; ">
<a title="Configurar Cuenta" href="{$tsConfig.url}/cuenta/">Cuenta</a>
<a title="Mis Borradores" href="{$tsConfig.url}/borradores.php">Borradores</a>
</li>
                    <li class="logout">
                ...
                <div id="login_box" style="display: none;">
                	...
                	<div class="login_cuerpo">
    	              ...
    	              <div id="login_error" style="display: none; padding:3px 0;"></div>
        	                    	           <div style="font-size:14px;float:right;text-align:left;"><img style="margin-top:75px;" src="{$tsConfig.tema.t_url}/images/llave_registro.png"></div>
						<form action="javascript:login_ajax()" method="post">
						<div id="cboxTitle">Entrar                    	<img title="Cerrar mensaje" onclick="close_login_box();" class="login_cerrar" src="{$tsConfig.tema.t_url}/images/lightbox.gif" style="top:10px;left:460px"></div><br><br>
