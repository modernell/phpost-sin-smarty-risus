...
//
var button_title = '     <? if($tsDraft){echo "Aplicar Cambios"; } else { echo "Agregar post";} ?>     ';
// 
...
$(document).ready(function(){
	...
	$('input[name=preview]').bind('click',function(){
		var error = false;
			...
			mydialog.show(true);
			mydialog.title('...');
			mydialog.body('Cargando vista previa....<br><br><img src="' + global_data.url + '/Temas/default/images/loading_bar.gif">');
            mydialog.center();
            // PREVIEW
			$.ajax({
				type: 'post',
