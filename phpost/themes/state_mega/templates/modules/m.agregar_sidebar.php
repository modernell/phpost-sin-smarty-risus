                        ...
                        <div id="upload_form">
                        <script type="text/javascript" src="<? echo $tsConfig['default']; ?>/js/jquery.form.js"></script>
                        ...
                        <form id="up_form" method="post" action="<? echo $tsConfig['url']; ?>/upload-images.php" enctype="multipart/form-data">
                            <div class="clearfix">
                            <p class="floatL">
