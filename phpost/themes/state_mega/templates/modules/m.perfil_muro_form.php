                                ...
                                <li>
                                    <ul class="atta">
                                        <li><span class="uiComposer">
                                            <i class="stream <? if ($tsInfo['uid'] == $tsUser->uid) echo 'status'; else echo 'mpub'; ?>"></i>
                                            <a href="#" class="a_blue hidden" onclick="muro.stream.load('status', this); return false;" id="stMain">
                                                <? if ($tsInfo['uid'] == $tsUser->uid) echo 'Estado'; else 'Publicaci&oacute;n'; ?>
                                            </a>
                                            <span><? if ($tsInfo['uid'] == $tsUser->uid) echo 'Estado'; else echo 'Publicaci&oacute;n'; ?></span>
                                            <i class="nub"></i>
                                        </span></li>
                                        <li><span class="uiComposer">
                                        ...
                                        <li class="streamLoader">
                                            <img width="16" height="11" alt="" src="http://static.ak.fbcdn.net/rsrc.php/yb/r/GsNJNwuI-UM.gif" class="img"/>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
