                        ...
                        <div class="boxy-content">
                        	...
                        	<ol>
                            	...
                            	<li class="categoriaUsuario clearfix">
                                    <img width="16" height="16" src="<? echo $tsConfig['url']; ?>/files/avatar/{$u.user_id}_50.jpg"/>
                                    <a href="<? echo $tsConfig['url']; ?>/perfil/{$u.user_name}">{$u.user_name}</a> <span>{$u.total}</span>
                                </li>
                                {/foreach}
                            </ol>
                            {/if}
